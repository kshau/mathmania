...
export type ResourceType = "all" | "lesson" | "video" | "quiz";

interface ResourcesGridProps {
  /** Show filter buttons to switch between resource types. */
  showFilters?: boolean;
  /** Initial filter type to show. */
  initialType?: ResourceType;
  /** Called when a resource card is clicked. Defaults to navigating to the resource details page. */
          ...
          >
            <div className="space-y-3 sm:space-y-4">
              <div className="flex items-start justify-between">
                ...
                <Badge
                  className={`${getTypeColor(resource.type)} capitalize text-xs sm:text-sm`}
                >
                  {resource.type}
                </Badge>
              </div>
